import { EMPTY_OBJ, isArray, isSymbol, isObject, hasOwn, toRawType, def, isFunction, makeMap, hasChanged, NOOP } from '@vue/shared/shared.js';
...
const shallowReactiveHandlers = { ...mutableHandlers,
  get: shallowGet,
  set: shallowSet
...
const shallowReadonlyHandlers = { ...readonlyHandlers,
...
function clear() {
  const target = toRaw(this);
  const hadItems = target.size !== 0; // forward the operation before queueing reactions
