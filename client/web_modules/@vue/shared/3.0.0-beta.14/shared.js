...
function mockWarn(asError = false) {
  ...
  afterEach(() => {
    ...
    const nonAssertedWarnings = warn.mock.calls.map(args => args[0]).filter(received => {
...
const isNoUnitNumericStyleProp =
/*#__PURE__*/
...
/*#__PURE__*/
makeMap('key,ref,' + 'onVnodeBeforeMount,onVnodeMounted,' + 'onVnodeBeforeUpdate,onVnodeUpdated,' + 'onVnodeBeforeUnmount,onVnodeUnmounted');
